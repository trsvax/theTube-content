...
The server is the boundary. It does what I tell it. I control what each path exposes. Different entry points, different views. Same data, scoped by who's asking. Not per-process like 9P, but per-credential — which maps better to the network world.
...
I don't need a wall. I just want a door.
